...
public class KernelConfig {
    ...
    public void setSchedulerType(SchedulerType schedulerType) { this.schedulerType = schedulerType; }
    ...
    public boolean isEnableDebugSyscalls() { return enableDebugSyscalls; }
    public void setEnableDebugSyscalls(boolean enableDebugSyscalls) { this.enableDebugSyscalls = enableDebugSyscalls; }
    
    public boolean isEnableFileSyscalls() { return enableFileSyscalls; }
    public void setEnableFileSyscalls(boolean enableFileSyscalls) { this.enableFileSyscalls = enableFileSyscalls; }
    
    public int getUartBufferSize() { return uartBufferSize; }
    public void setUartBufferSize(int uartBufferSize) { this.uartBufferSize = uartBufferSize; }
}