...
public class Kernel {
    ...
    public RV32iCpu getCpu() { return cpu; }
    public MemoryManager getMemory() { return memory; }
    public TaskManager getTaskManager() { return taskManager; }
    public Scheduler getScheduler() { return scheduler; }
    public SystemCallHandler getSystemCallHandler() { return syscallHandler; }
    public KernelMemoryManager getKernelMemory() { return kernelMemory; }
